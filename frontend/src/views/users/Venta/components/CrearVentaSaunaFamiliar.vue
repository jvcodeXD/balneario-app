<template>
  <v-card>
    ...
    <v-card-actions class="justify-end">
      ...
      <v-btn color="success" @click="crearVentaSauna">Aceptar</v-btn>
    </v-card-actions>
  </v-card>
</template>
...
import { createVenta, getAmbienteById, imprimirVenta } from '@/services'
...
const calcularDiferencia = () => {
  ...
  form.precio_total = parseFloat((precio.value * horasDecimal).toFixed(2))
}
...
const obtenerAmbiente = async () => {
  try {
    ...
    form.precio_total = ambiente.value.precio!.precio
